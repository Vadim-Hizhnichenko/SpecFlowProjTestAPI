...
Scenario: PostUserWithListMethod
	...
	And I send request to API
	Then User should be see code status '200' and 'ok' message
...
Scenario: GetUserByUserNameMethod
	...
	And I create body request for user 
	| id | username | firstName | lastName | email | password | phone    | userStatus |
	| 44 | newuser | First     | Last     | Email | 123456   | 09080707 | 1          |
	And I send request to API
	When I create 'GET' request to '/user/{username}'
	And I set url string segment 'username' to 'newuser'
	And I send request to API
	Then I get user by his name 'newuser' 
...
Scenario: DeleteMethodByUseName
	...
	And I send request to API
	Then User should be see code status '200' and username 'fafa' was deleted
...
Scenario: PutByUsernameMethod
	...
	And I send request to API
	Then User should be see code status '200' and message '17' id 